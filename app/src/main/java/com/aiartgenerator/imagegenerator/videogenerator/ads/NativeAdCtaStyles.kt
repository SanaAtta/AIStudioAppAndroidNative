 ...
 * ```json
 * "native_ad_cta": {
 *   "without_media": { "gradient_start": "#7C4DFF", "gradient_end": "#5C2DF5", "text_color": "#FFFFFF" },
 *   "with_media": { "background_color": "#5C2DF5", "text_color": "#FFFFFF" },
 *   "fullscreen": { "gradient_start": "#7C4DFF", "gradient_end": "#5C2DF5", "text_color": "#FFFFFF" }
 * }
 * ```
 *
...
object NativeAdCtaStyles {
    private const val DEFAULT_GRADIENT_START = 0xFF7C4DFF.toInt()
    private const val DEFAULT_GRADIENT_END = 0xFF5C2DF5.toInt()
